...
namespace realtimeplot {
	...
	class BackendPlot {
		public:
			...
			/**
			 * \brief Zoom in or out according to the given scale and around a specific point provided in pixel coordinates
			 */
			void zoom_around_pixel( double scale, int x, int y );
